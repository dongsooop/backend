 ...
 */
@Component
public class BlindDateMessageProvider {
    ...
    public List<String> getStartMessages() {
        return Arrays.asList(START_MESSAGES);
    }

    public List<String> getRandomEventMessages(int count) {
        List<String> messages = new ArrayList<>(Arrays.asList(EVENT_MESSAGES));
