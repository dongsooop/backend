...
public class SettingCreate extends SettingChanges {

    public SettingCreate(NotificationSetting setting, MemberDevice device, NotificationType type, boolean targetState) {
