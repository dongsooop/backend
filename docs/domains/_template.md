...
이 도메인이 **소유하는 용어**를 정의합니다.

같은 개념에 여러 이름을 사용하지 않습니다.

연결된 다른 도메인이 이 개념을 사용해야 한다면 여기에서 정의한 용어를 그대로 사용합니다.

다른 도메인이 소유한 용어는 여기에서 다시 정의하지 않고 해당 문서를 참조합니다.

프로젝트 전반의 공통 용어는 `../glossary.md`를 따릅니다.
...
다른 도메인이 소유한 결정이나 용어가 현재 도메인과 연결된다면 여기에 해당 문서를 추가합니다.
